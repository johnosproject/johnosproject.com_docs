...
## [John Objects](/docs/references/jod_dists/)


<Grid container spacing={4}>
  <Grid item xs={2}>
    <img src="/docs/img/icons/JOD_Icon_250.png" width="200" />
  </Grid>
  <Grid item xs={10}>
...
## [John Services](/docs/references/jsl_services/)
...
This list, among others, includes Universal JOSP Objects for different platforms (Web, Mobile, PC, Voice Assistants, etc...). Depending on native platform (Windows, Android...) different steps are required to install/setup the JOSP Service.
  ...
  <Grid item xs={2}>
    <img src="/docs/img/icons/JSL_Icon_250.png" width="200" />
  </Grid>
</Grid>

---

## [Tools & Utils](/docs/references/tools/)

<Grid container spacing={4}>
  <Grid item xs={2}>
    <img src="/docs/img/icons/Tools_Icon_250.png" width="200" />
  </Grid>
  <Grid item xs={10}>

Other **JOSP tools and utils to handle JOSP components**.

Here you can find tools to manage objects, like the [JOD Object Remote](/docs/references/tools/john_object_remote/) that allow you to manage remote JOD installations; or the [JOD Distribution TEMPLATE](/docs/references/tools/jod_dist_template/) the basic folder for any JOD Distribution.
...
## [JOSP Components](/docs/references/josp/)
...
You can find details about JOD Agent's configuration and his structure, but also how his workers are implemented and how to extend them. On the other side you can find the API reference of the John Service Library, useful for JOSP Service developers.
  ...
  <Grid item xs={2}>
    <img src="/docs/img/logo/logo_text_250.png" width="200" />
  </Grid>
</Grid>
