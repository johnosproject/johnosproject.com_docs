...
[Register](/docs/guides/end_users/new_objects/register_object) your connected objects to the JOSP EcoSystem, then [interact](/docs/guides/end_users/manage_services/use_objects) with them from any software enabled.<br/>
**That's it! Your IoT Solution is ready.**

---

This is the JOSP Docs official website.
Within those pages you can find all [JOSP Project](/docs/what/josp/)'s related documentation.<br/>
...
* the **['What is?'](/docs/what)** section describe what is IoT and introduce the JOSP Project
* in the **[Guides](/docs/guides)** section there are all user's guides grouped by End User, Makers and Developer
* finally, in the **[Reference](/docs/references)** section are contained all references of JOSP Project's software and tools 

---

## What the JOSP Project provides?

The JOSP Project not only provide a **ready-to-use JOSP EcoSystem**, with the [Public JCP platform](/docs/references/josp/jcp/public_jcp), but also **all EcoSystem's components as Open Source** software and libraries.<br/>
...
* **[John Object Daemon](/docs/references/josp/jod/)**<br/>
...
* **[John Service Library](/docs/references/josp/jsl/)**<br/>
...
* **[John Cloud Platform](/docs/references/josp/jcp/)**<br/>
...
Or to create [JOSP Objects](/docs/what/josp/object) and [Services](/docs/what/josp/service) as IoT Components to be used in [JOSP Solutions](/docs/what/josp/solution).<br/>
...
* The [JOD Distribution TEMPLATE](/docs/references/tools/jod_dist_template/) as starting point for custom JOD Distributions
* All published [JOSP Objects](/docs/references/jod_dists/#real-physical-objects) and [JOD Distributions](/docs/references/jod_dists/) (they can be used as examples)
...
* All published [JOSP Services](/docs/references/jsl_services/) (they can be used as source of inspiration)
...
### [End Users](/docs/guides/end_users/)
...
### [Developers](/docs/guides/developers/)
