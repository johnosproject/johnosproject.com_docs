...
An [IoT Ecosystem](/what/iot/ecosystem) is a tool that helps users manage their [IoT Solutions](/what/iot/solution), made up of connected [objects](/what/iot/object) and [software](/what/iot/service) that interact with them.
In a [JOSP EcoSystem](/what/josp/ecosystem), objects are represented by [JOSP Objects](/what/josp/object), while software is called [JOSP Services](/what/josp/service).
...
Special JOSP services are the [Johnny Services](/references/jsl_services/#johnny-services), a set of software provided by the JOSP project for multiple platforms (mobile, desktop, web, voice).
...
See [What objects can be represented?](../new_objects/what_object_represent) for more details on object's nature.
...
Please review the [What objects can be represented?](../new_objects/what_object_represent) page for more details on object's nature, and the [poweron JOSP Object](../new_objects/poweron_object) or [run JOD Distribution](../new_objects/run_distribution) pages to startup a JOSP Object.<br/>
...
[JOSP Permissions](/what/josp/specs/permissions) have been designed to guarantee a high degree of customization.
