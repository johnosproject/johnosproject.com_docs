...
To register a JOSP Object, it must be running (as AnonymousObject), connected to the Public JCP and you must know his [object's id](/docs/references/josp/jod/specs/object_id).<br/>
