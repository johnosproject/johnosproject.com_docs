...
If you are [logged in](login_user_account), here are listed all JOSP Objects that you own (Current user is the object's owner) or that another user shared with you (Current user and JCP Front End service have at least [STATE](/docs/what/josp/specs/permissions#state) permission).<br/>
If you are NOT logged in, then only public JOSP Objects are displayed. Public objects are all JOSP Objects that grant at least the [STATE](/docs/what/josp/specs/permissions#state) permission to ['#All'](/docs/what/josp/specs/permissions#placeholders) users and current JOSP Service ('jcp-fe' service's id or '#All' placeholder).
