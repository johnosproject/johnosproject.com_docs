...
<ReferenceIntro
  logo_path="/img/icons/JCP_Icon_250.png">

The **John Cloud Platform is a collection of microservices that compone the cloud component for a [JOSP EcoSystem](/what/josp/ecosystem)**.
...
The JCP platform main goal is to allow [JOSP Objects](/what/josp/object) and [JOSP Services](/what/josp/service) communicate also when they are not on the seme network.
...
* [JCP JSL Web Bridge](microservices/jslwb/): the server implementation for [JSL Http](/references/josp/jsl/langs/http/) implementation.
