...
The **John Service Library is a collection of libraries to interact with [JOSP Object](/what/josp/object) via the [JOSP EcoSystem](/what/josp/ecosystem)**.
Those libraries can be included in 3rd party software, And each software that include this library become a [JOSP Services](/what/josp/service).
